 ...
 */
@ApiModel(description = "Represents a comment thread of a pull request. A thread contains meta data about the file it was left on (if any) along with one or more comments (an initial comment and the subsequent replies).")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2024-07-28T21:17:42.501+02:00")
public class GitPullRequestCommentThread extends CommentThread {
  @JsonProperty("_links")
  ...
  private GitPullRequestCommentThreadContext pullRequestThreadContext = null;

  public GitPullRequestCommentThread links(ReferenceLinks links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public GitPullRequestCommentThread comments(List<Comment> comments) {
    this.comments = comments;
    return this;
  }

  public GitPullRequestCommentThread addCommentsItem(Comment commentsItem) {
  ...
  **/
  ...
  public GitPullRequestCommentThread id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public GitPullRequestCommentThread identities(Map<String, IdentityRef> identities) {
    this.identities = identities;
    return this;
  }

  public GitPullRequestCommentThread putIdentitiesItem(String key, IdentityRef identitiesItem) {
  ...
  **/
  ...
  public GitPullRequestCommentThread isDeleted(Boolean isDeleted) {
  ...
  **/
  ...
  public GitPullRequestCommentThread lastUpdatedDate(OffsetDateTime lastUpdatedDate) {
  ...
  **/
  ...
  public GitPullRequestCommentThread properties(PropertiesCollection properties) {
  ...
  **/
  ...
  public GitPullRequestCommentThread publishedDate(OffsetDateTime publishedDate) {
  ...
  **/
  ...
  public GitPullRequestCommentThread threadContext(CommentThreadContext threadContext) {
  ...
  **/
  ...
  public GitPullRequestCommentThread pullRequestThreadContext(GitPullRequestCommentThreadContext pullRequestThreadContext) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, comments, id, identities, isDeleted, lastUpdatedDate, properties, publishedDate, threadContext, pullRequestThreadContext, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class GitPullRequestCommentThread {\n");
    ...
    sb.append("    pullRequestThreadContext: ").append(toIndentedString(pullRequestThreadContext)).append("\n");
    sb.append("}");
    return sb.toString();
  }
