 ...
 */
@ApiModel(description = "Real time event (SignalR) for a discussions update on a pull request")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2024-07-28T21:17:42.501+02:00")
public class DiscussionsUpdatedEvent extends RealTimePullRequestEvent {
  ...
  public DiscussionsUpdatedEvent eventId(UUID eventId) {
  ...
  **/
  ...
  public DiscussionsUpdatedEvent pullRequestId(Integer pullRequestId) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class DiscussionsUpdatedEvent {\n");
