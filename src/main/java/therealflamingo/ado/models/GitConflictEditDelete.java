 ...
 */
@ApiModel(description = "Data object for DeleteEdit conflict")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2024-07-28T21:17:42.501+02:00")
public class GitConflictEditDelete extends GitConflict {
    @JsonProperty("_links")
    ...
    public GitConflictEditDelete links(ReferenceLinks links) {
        this.links = links;
        return this;
    }
    ...
    public GitConflictEditDelete conflictId(Integer conflictId) {
    ...
    public GitConflictEditDelete conflictPath(String conflictPath) {
    ...
    public GitConflictEditDelete mergeBaseCommit(GitCommitRef mergeBaseCommit) {
    ...
    public GitConflictEditDelete mergeOrigin(GitMergeOriginRef mergeOrigin) {
    ...
    public GitConflictEditDelete mergeSourceCommit(GitCommitRef mergeSourceCommit) {
    ...
    public GitConflictEditDelete mergeTargetCommit(GitCommitRef mergeTargetCommit) {
    ...
    public GitConflictEditDelete resolvedBy(IdentityRef resolvedBy) {
    ...
    public GitConflictEditDelete resolvedDate(OffsetDateTime resolvedDate) {
    ...
    public GitConflictEditDelete url(String url) {
        this.url = url;
        return this;
    }
    ...
    public GitConflictEditDelete baseBlob(GitBlobRef baseBlob) {
    ...
    public GitConflictEditDelete resolution(GitResolutionPickOneAction resolution) {
    ...
    public GitConflictEditDelete sourceBlob(GitBlobRef sourceBlob) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GitConflictEditDelete gitConflictEditDelete = (GitConflictEditDelete) o;
        return Objects.equals(this.links, gitConflictEditDelete.links) &&
                Objects.equals(this.conflictId, gitConflictEditDelete.conflictId) &&
                Objects.equals(this.conflictPath, gitConflictEditDelete.conflictPath) &&
                Objects.equals(this.mergeBaseCommit, gitConflictEditDelete.mergeBaseCommit) &&
                Objects.equals(this.mergeOrigin, gitConflictEditDelete.mergeOrigin) &&
                Objects.equals(this.mergeSourceCommit, gitConflictEditDelete.mergeSourceCommit) &&
                Objects.equals(this.mergeTargetCommit, gitConflictEditDelete.mergeTargetCommit) &&
                Objects.equals(this.resolvedBy, gitConflictEditDelete.resolvedBy) &&
                Objects.equals(this.resolvedDate, gitConflictEditDelete.resolvedDate) &&
                Objects.equals(this.url, gitConflictEditDelete.url) &&
                Objects.equals(this.baseBlob, gitConflictEditDelete.baseBlob) &&
                Objects.equals(this.resolution, gitConflictEditDelete.resolution) &&
                Objects.equals(this.sourceBlob, gitConflictEditDelete.sourceBlob) &&
                super.equals(o);
    }

    @Override
    public int hashCode() {
        return Objects.hash(links, conflictId, conflictPath, mergeBaseCommit, mergeOrigin, mergeSourceCommit, mergeTargetCommit, resolvedBy, resolvedDate, url, baseBlob, resolution, sourceBlob, super.hashCode());
    }
    ...
    public String toString() {
        ...
        sb.append("class GitConflictEditDelete {\n");
