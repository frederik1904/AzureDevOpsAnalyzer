 ...
 */
@ApiModel(description = "Real time event (SignalR) for a completion errors on a pull request")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2024-07-28T21:17:42.501+02:00")
public class CompletionErrorsEvent extends RealTimePullRequestEvent {
  ...
  public CompletionErrorsEvent eventId(UUID eventId) {
  ...
  public CompletionErrorsEvent pullRequestId(Integer pullRequestId) {
  ...
  public CompletionErrorsEvent errorMessage(String errorMessage) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventId, pullRequestId, errorMessage, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class CompletionErrorsEvent {\n");
